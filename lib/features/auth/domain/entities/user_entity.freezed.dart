...
mixin _$UserEntity {
  ...
  dynamic get trustLevel => throw _privateConstructorUsedError;
...
class _$UserEntityImpl implements _UserEntity {
  ...
  @override
  String toString() {
    return 'UserEntity(userUuid: $userUuid, customerOrManufacturerUuid: $customerOrManufacturerUuid, username: $username, email: $email, password: $password, phoneNumber: $phoneNumber, companyName: $companyName, companyDescription: $companyDescription, city: $city, trustLevel: $trustLevel, role: $role, status: $status, lastLogin: $lastLogin, token: $token, refreshToken: $refreshToken)';
  }
...
abstract class _UserEntity implements UserEntity {
  const factory _UserEntity(
      ...
      final dynamic lastLogin,
      final dynamic token,
      final dynamic refreshToken}) = _$UserEntityImpl;
