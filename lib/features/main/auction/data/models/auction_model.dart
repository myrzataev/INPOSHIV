...
List<AuctionModel> auctionModelFromJson(String str) => List<AuctionModel>.from(
    json.decode(str).map((x) => AuctionModel.fromJson(x)));

String auctionModelToJson(List<AuctionModel> data) =>
...
class AuctionProcess with _$AuctionProcess {
  ...
  factory AuctionProcess.fromJson(Map<String, dynamic> json) =>
      _$AuctionProcessFromJson(json);
}
