...
class _$ProductCategoriesModelImpl implements _ProductCategoriesModel {
  ...
  @override
  String toString() {
    return 'ProductCategoriesModel(orderId: $orderId, orderStatus: $orderStatus, products: $products, customerName: $customerName, createdAt: $createdAt, auctonsUuid: $auctonsUuid)';
  }
...
abstract class _ProductCategoriesModel implements ProductCategoriesModel {
  const factory _ProductCategoriesModel(
      ...
      final String? customerName,
      final DateTime? createdAt,
      final List<String>? auctonsUuid}) = _$ProductCategoriesModelImpl;
